...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.PrimarySoldier"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamAMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamAMainBotSpeed = 10, //1 unit = 1mm, distance performed at step movement
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.SecondarySoldier"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamASecondaryBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamASecondaryBotSpeed = 10, //1 unit = 1mm, distance performed at step movement
